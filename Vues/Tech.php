...
<center>
  <div class="well center-block" style="max-width:400px;margin-top:100px">
    ...
    <form  method="post" enctype="multipart/form-data" action="index.php">
      ...
      <input class="btn btn-default btn-lg btn-block" name="Importer" type="submit" value="Importer" />
    </form>
    </br>
    </br>
    ...
    ?></p>
      <input class="btn btn-default btn-lg btn-block"  name="submitRes" type="submit" value="Exporter" />
    </form>
    </br>
    </br>
    ...
    <form  method="post" action="index.php">
      <input class="btn btn-default btn-lg btn-block" name="submitLog" type="submit" value="Exporter" />
    </form>
    </br>
    </br>
